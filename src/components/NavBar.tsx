...
const Navbar: FC = async () => {
  ...
  return (
    <div className='fixed backdrop-blur-sm bg-slate-200/75 dark:bg-slate-900/75 z-100 top-0 left-0 mb-20 right-0 h-20 shadow-sm flex items-center justify-between'>
